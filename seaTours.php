                    ...
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="course-item">
                            <div class="c-thumb course-thumb">
                                <a href="toursDetails.php?id=<?= $tour['id'] ?>&pageName=<?= urlencode('Sea Tours')?>&cat=seaTours ">
                            ...
                            <div class="course-content">
                                ...
                                <a href="toursDetails.php?id=<?= $tour['id'] ?>&pageName=<?= urlencode('Sea Tours')?>&cat=seaTours ">Read More</a>
                            </div>
                        </div>
                    </div>
