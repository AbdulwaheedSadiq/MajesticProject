    ...
    <section class="course-section padding-top padding-bottom">
        <div class="container">
            <div class="row justify-content-center mb-30-none">
                <?php foreach ($seaTours as $tour): ?>
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="course-item">
                            <div class="c-thumb course-thumb">
                                <a href="toursDetails.php?id=<?= $tour['id'] ?>&pageName=<?= urlencode('Land Tours')?>&cat=landTours ">
                            ...
                            <div class="course-content">
                                ...
                                <a href="toursDetails.php?id=<?= $tour['id'] ?>&pageName=<?= urlencode('Land Tours')?>&cat=landTours ">Read More</a>
                            </div>
                        </div>
                    </div>
