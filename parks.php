...
<body>
  ...
  <section class="hero-section">
        <div class="hero-area bg_img" data-background="assets/images/about/hero-bg.jpg">
            <div class="container">
                <h1 class="title">National Park Safaris</h1>
            </div>
        </div>
        <div class="container">
            <ul class="breadcrumb">
                    ...
                    <div class="col-md-6 col-sm-10 col-lg-4">
                        <div class="course-item">
                            <div class="c-thumb course-thumb">
                                <a href="toursDetails.php?id=<?= $tour['id'] ?>&pageName=<?= urlencode('National Park Safaris')?>&cat=parks">
                            ...
                            <div class="course-content">
                                ...
                                <a href="toursDetails.php?id=<?= $tour['id'] ?>&pageName=<?= urlencode('National Park Safaris')?>&cat=parks">Read More</a>
                            </div>
                        </div>
                    </div>
